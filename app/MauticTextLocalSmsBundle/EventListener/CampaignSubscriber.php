...
use MauticPlugin\MauticTextLocalSmsBundle\Model\SmsModel;
use MauticPlugin\MauticTextLocalSmsBundle\SmsEvents;
...
class CampaignSubscriber implements EventSubscriberInterface
{
    ...
    {
        $integration = $this->integrationHelper->getIntegrationObject('TextLocal');
        ...
        if ($integration && $integration->getIntegrationSettings()->getIsPublished()) {
            $event->addAction(
                ...
                [
                    ...
                    'formType'         => 'textlocalsmssend_list',
                    'formTypeOptions'  => ['update_select' => 'campaignevent_properties_sms'],
                    'formTheme'        => 'MauticTextLocalSmsBundle:FormTheme\SmsSendList',
                    'timelineTemplate' => 'MauticTextLocalSmsBundle:SubscribedEvents\Timeline:index.html.php',
                    'channel'          => 'sms',
                    'channelIdField'   => 'sms',
                ]
            );
